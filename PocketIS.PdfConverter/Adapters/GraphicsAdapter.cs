...
namespace PocketIS.PdfConverter.Adapters
{
    ...
    internal sealed class GraphicsAdapter : RGraphics
    {
        ...
        public override RSize MeasureString(string str, RFont font)
        {
            ...
            var size = _g.MeasureString(str, realFont, StringFormat);
        ...
        {
            var xBrush = ((BrushAdapter)PdfSharpAdapter.Instance.GetSolidBrush(color)).Brush;
            _g.DrawString(str, ((FontAdapter)font).Font, (XBrush)xBrush, point.X, point.Y, StringFormat);
        }

        public override RBrush GetTextureBrush(RImage image, RRect dstRect, RPoint translateTransformLocation)
        {
            return new BrushAdapter(new XTextureBrush(((ImageAdapter)image).Image, Utils.Convert(translateTransformLocation)));
        }
